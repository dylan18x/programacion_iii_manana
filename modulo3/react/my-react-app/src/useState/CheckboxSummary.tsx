...
export default function CheckboxSummary() {
  ...
  return (
    <div>
      ...
      <label><input type="checkbox" checked={checked.a} onChange={() => setChecked({ ...checked, b: !checked.b })} /> B</label>
      <label><input type="checkbox" checked={checked.b} onChange={() => setChecked({ ...checked, z: !checked.z })} /> Z</label>
